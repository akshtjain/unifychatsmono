    ...
    <div>
      ...
      <div className="relative mb-4">
        <input
          ...
          className="w-full px-4 py-3 pl-10 bg-card border border-border rounded-xl text-foreground placeholder-muted-foreground focus:outline-none focus:border-primary transition-colors"
        />
        <svg
